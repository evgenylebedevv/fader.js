...
// Затухание (исчезновение) элемента
    Fader.fadeOutWithId('third', 1, function() {
      // Альтернативный необязательный код, который выполнится после завершения затухания
    });
...
document.addEventListener('DOMContentLoaded', function() {
  document.getElementById('second').addEventListener('click', function() {
    ...
    Fader.fadeInWithId('third', 1, function() {
      // Альтернативный необязательный код, который выполнится после завершения появления
    });
